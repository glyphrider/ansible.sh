# updated script for zsh (the good shell)
#
...
function aws_common {
  ...
  PS1="$(prompt_effect ${1}_bg)$(prompt_effect black)%t($(date +%Z)) | aws:$(prompt_effect bold)${AWS_ACCOUNT}$(prompt_effect unbold)@\${AWS_REGION} | %m:%n$(prompt_effect default_bg)$(prompt_effect default)
[%!]%# "
